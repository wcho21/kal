...
export const createGroupDelimiterToken: CreateToken<GroupDelimiterToken> = createTokenCreator<GroupDelimiterToken>("group delimiter");
export const createBlockDelimiterToken: CreateToken<BlockDelimiterToken> = createTokenCreator<BlockDelimiterToken>("block delimiter");
