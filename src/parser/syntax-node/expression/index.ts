...
export interface TableNode extends SyntaxNodeBase<"table"> {
  elements: [ExpressionNode, ExpressionNode][];
}
...
export const createBooleanNode: CreateNode<"boolean", BooleanNode> = createNodeCreator<"boolean", BooleanNode>(
  "boolean",
);
...
export const createFunctionNode: CreateNode<"function", FunctionNode> = createNodeCreator<"function", FunctionNode>(
  "function",
);
export const createCallNode: CreateNode<"call", CallNode> = createNodeCreator<"call", CallNode>("call");
export const createAssignmentNode: CreateNode<"assignment", AssignmentNode> = createNodeCreator<
  "assignment",
  AssignmentNode
>("assignment");
export const createListNode: CreateNode<"list", ListNode> = createNodeCreator<"list", ListNode>("list");
export const createTableNode: CreateNode<"table", TableNode> = createNodeCreator<"table", TableNode>("table");
